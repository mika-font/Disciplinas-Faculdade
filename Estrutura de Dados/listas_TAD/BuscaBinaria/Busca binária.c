...
// Busca binária em uma tabela de alunos
...
// Função para inserir dados na tabela de alunos de forma linear e estática
...
// Função para imprimir todos os dados da tabela de alunos de forma linear
...
int buscaBinaria(universidade aluno[], int mat, int fim) {  // vari�vel fim armazena o �ltimo registro da tabela
